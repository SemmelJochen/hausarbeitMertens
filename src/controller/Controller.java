...
public class Controller {
	...
	public static void main(String[] args) {
		...
		//ContentPane contentPane = new ContentPane(new JLabel("Studenten�bersicht") ,table1.getContent());
		
		//Table table2 = new Table(erstgutachteruebersicht.erstgutachterUebersicht());
		//ContentPane contentPane = new ContentPane(new JLabel("Erstgutachter�bersicht") ,table2.getContent());
		
		//Table table3 = new Table(zweitgutachteruebersicht.zweitgutachterUebersicht());
		//ContentPane contentPane = new ContentPane(new JLabel("Zweitgutachter�bersicht") ,table3.getContent());
